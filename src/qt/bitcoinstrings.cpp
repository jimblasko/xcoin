...
"for example: alertnotify=echo %%s | mail -s \"Xcoin Alert\" admin@foo."
"com\n"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or Xcoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify pid file (default: Xcoind.pid)"),
