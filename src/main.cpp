...
static const int64_t nTargetTimespan = 240 * 60;  // Xcoin - every 4 hour
unsigned int nTargetSpacing = 1 * 60; // Xcoin - 1 minute
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "February 25, 2015 - CoinJar Swipe Bitcoin Debit Cards Now Available - coindesk.com";
        CTransaction txNew;
        txNew.nTime = 1425040115;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1425040115;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 855957 : 855957;



        assert(block.hashMerkleRoot == uint256("0x689609f18131c1f7008b13e3700e36b56e9f884dbd099c535a363acfa83c26c5"));
...
unsigned char pchMessageStart[4] = { 0xa5, 0xd2, 0xd7, 0xa6 };
